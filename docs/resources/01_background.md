...
When working with Azure, it's important understand how [Azure organizes the infrastructure for management]((https://docs.microsoft.com/en-us/azure/cloud-adoption-framework/ready/azure-setup-guide/organize-resources?tabs=AzureManagementGroupsAndHierarchy)
), billing and security purposes. While complex setups are probably an overkill here,
it is good to have a bare minimum of understanding, so we'll know where to go look when our needs grow.

![Azure infra management structure](./images/01_azure_scope_mgmt.png)
...
### GitOps or not to GitOps? That is the question.
...
![Infrastructure Lifecycle](./images/infra-lifecycle.png)
...
![High level CI/CD flow](./images/CI-CD-Workflow-high-level.png)

- A detailed breakdown of the various tasks involved

![CI/CD flow details](./images/CI-CD-Workflow-detailed.png)
